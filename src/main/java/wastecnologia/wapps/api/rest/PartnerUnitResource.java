...
import wastecnologia.wapps.api.model.PartnerUnitDTO;
import wastecnologia.wapps.api.repos.PartnerRepository;
...
public class PartnerUnitResource {

    private final PartnerUnitService partnerUnitService;
    private final PartnerRepository partnerRepository;

    public PartnerUnitResource(final PartnerUnitService partnerUnitService,
