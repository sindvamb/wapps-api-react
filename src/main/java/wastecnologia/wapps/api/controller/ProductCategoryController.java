...
import wastecnologia.wapps.api.domain.dto.ProductCategoryDTO;
import wastecnologia.wapps.api.service.ProductCategoryService;
...
public class ProductCategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UUID> updateProductCategory(@PathVariable(name = "id") final UUID id,
            @RequestBody @Valid final ProductCategoryDTO productCategoryDTO) {
    ...
    public ResponseEntity<Void> deleteProductCategory(@PathVariable(name = "id") final UUID id) {
        final ReferencedWarning referencedWarning = productCategoryService.getReferencedWarning(id);
