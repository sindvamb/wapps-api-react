...
export default function OrderEdit() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(updateOrder)} noValidate>
      <input type="submit" value={t('order.edit.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 cursor-pointer mt-6 mb-5" />
      <InputRow useFormResult={useFormResult} object="order" field="id" disabled={true} />
