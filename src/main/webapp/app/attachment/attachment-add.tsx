...
export default function AttachmentAdd() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(createAttachment)} noValidate>
      ...
      <input type="submit" value={t('attachment.add.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 cursor-pointer mt-6" />
    </form>
  </>);
}
