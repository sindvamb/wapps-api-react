...
//
// // Componente Switch
// const Switch = ({ isOn, handleToggle, label }: { isOn: boolean; handleToggle: () => void; label: string }) => (
//   <div className="flex items-center">
//     <span className="text-xs text-gray-400 mr-2">{label}</span>
//     <button
//       onClick={handleToggle}
//       className={`relative inline-flex items-center h-5 rounded-full w-9 transition-colors duration-300 focus:outline-none ${isOn ? 'bg-blue-600' : 'bg-gray-600'}`}>
//       <span
//         className={`inline-block w-4 h-4 transform bg-white rounded-full transition-transform duration-300 ${isOn ? 'translate-x-4' : 'translate-x-1'}`}/>
//     </button>
//   </div>
// );
//
...
//                 { path: '/emailHistories', translationKey: 'emailHistory.list.headline', icon: <CollectionIcon className="text-gray-400" /> },
//             ],
//         },
//     ];
//
//     // Define o estado inicial dos grupos expandidos
//     const initializeExpandedGroups = () => {
//         const initialExpanded: Record<string, boolean> = {};
//         if (isAccordionMode) {
//             const defaultOpenGroup = navGroups.find(group => group.defaultOpen);
//             if (defaultOpenGroup) {
//                 initialExpanded[defaultOpenGroup.title] = true;
//             }
//         } else {
...
//     };
//
//     // Inicializa os grupos expandidos na montagem e quando o modo acordeão muda
//     useEffect(() => {
...
//                     <Switch
//                         isOn={isAccordionMode}
//                         handleToggle={() => setIsAccordionMode(!isAccordionMode)}
//                         label={t('navigation.accordionMode')}
//                     />
//                 </div>
//             )}
//
