...
export default function EventAdd() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(createEvent)} noValidate>
      ...
      <input type="submit" value={t('event.add.headline')} className="inline-block text-white bg-blue-600 hover:bg-blue-700 focus:ring-blue-300  focus:ring-4 rounded px-5 py-2 cursor-pointer mt-6" />
    </form>
  </>);
}
